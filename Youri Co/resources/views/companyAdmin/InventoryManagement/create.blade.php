...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form name="formCreate" id="formCreate" method="POST" action="{{ route('company-inventory_management.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <h3 class="card-title">Inventory Management Info</h3>
                            <hr>
                            <div class="row p-t-20">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="product_description" id="product_description" class="form-control @error('product_description') is-invalid @enderror">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="unit_price" id="unit_price" class="form-control @error('unit_price') is-invalid @enderror">
                                        @error('unit_price')
                                            <small class="form-control-feedback text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label"> Recorder Point</label>
                                        <input type="text" name="recorder_point" id="recorder_point" class="form-control @error('recorder_point') is-invalid @enderror">
                                        @error('recorder_point')
                                            <small class="form-control-feedback text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Recorder Quantity</label>
                                        <input type="text" name="recorder_quatity" id="recorder_quatity" class="form-control @error('recorder_quatity') is-invalid @enderror">
                                        @error('recorder_quatity')
                                            <small class="form-control-feedback text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                </div>
