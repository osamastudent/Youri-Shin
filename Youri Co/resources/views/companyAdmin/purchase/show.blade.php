                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <ul>
                                @foreach ($sale->getItemsArray() as $item)
                                    <li>{{ $item }}</li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            @if($sale->status == 0)
                                <img src="/dist/1.gif" width="300" height="200">
                            @elseif($sale->status == 1)
                                <img src="/dist/2.gif" width="300" height="200">
                            @elseif($sale->status == 2)
                                <img src="/dist/3.gif" width="300" height="200">
                            @elseif($sale->status == 3)
                                <img src="/dist/4.gif" width="300" height="200">
                            @elseif($sale->status == 4)
                                <img src="/dist/5.gif" width="300" height="200">
                            @endif
                        </div>
                    </div>
                    <hr>
