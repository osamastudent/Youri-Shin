...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form name="formCreate" id="formCreate" method="POST" action="{{ route('package.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            ...
                            <div class="row p-t-20">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="no_of_admins" id="no_of_admins" class="form-control @error('no_of_admins') is-invalid @enderror" value="{{ old('no_of_admins') }}">
                                        @error('no_of_admins')
                                            <small class="form-control-feedback text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="row p-t-20">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="no_of_setup" id="no_of_setup" class="form-control @error('no_of_setup') is-invalid @enderror" value="{{ old('no_of_setup') }}">
                                        @error('no_of_setup')
                                            <small class="form-control-feedback text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="no_of_staff" id="no_of_staff" class="form-control @error('no_of_staff') is-invalid @enderror" value="{{ old('no_of_staff') }}">
                                        @error('no_of_staff')
                                            <small class="form-control-feedback text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="row p-t-20">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="no_of_customers" id="no_of_customers" class="form-control @error('no_of_customers') is-invalid @enderror" value="{{ old('no_of_customers') }}">
