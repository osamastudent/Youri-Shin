...
<head>
<title>JMS | Jal Management System</title>

<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="description" content="Smart Solutions for Water Supply">
<meta name="keywords" content="Water Supply, Mineral Water, Water Supply Management Company">
<meta name="author" content="Hash Pixels">
<meta property="og:image" content="https://jalmanagementsystem.com/img/about/1.jpg">
...
<div class="arlo_tm_all_wrap" data-magic-cursor="" data-color="crimson">
	...
	<div class="arlo_tm_mobile_menu">
		<div class="mobile_menu_inner">
			<div class="container">
				<div class="mobile_in">
					<div class="logo">
						<a href="#"><img src="img/about/1.jpg" alt="" /></a>
					</div>
	...
	<div class="arlo_tm_leftpart ">
        <div class="inner">
            <div class="logo">
                <a href="#"><img src="img/logo/sidebar/2.png" alt="" /></a>
            </div>
	...
	<div class="arlo_tm_rightpart "> 
		...
		<div class="arlo_tm_hero" id="home">
			<div class="background">
				<div class="image ripple" id="ripple"></div>
			</div>
			<div class="content">
				...
				<div class="name_holder">
					<h3>Water Delivery <span style="color:#419AD2;">Software</span></h3>   
				</div>
				<div class="text_typing">
					<p>We Have <span class="arlo_tm_animation_text_word"></span></p>
				</div>
			</div>
				...
				<div class="about_inner">
					<div class="left">
						<div class="about_image_wrap parallax" data-relative-input="true">
							<div class="image layer" data-depth="0.1">
								<img src="img/ratios/550x650.jpg" alt="" width="250" height="250" />
					...
					<div class="right">
						<div class="about_title">
							<h3>Jal Management System contains <br><span class="arlo_tm_animation_text_word"></span></h3>
						<br>
						<div class="text">
							<p>Welcome to <span>JAL MANAGEMENT SYSTEM</span>, the leading mineral water supply management system dedicated to delivering the purest and highest quality water to customer's doorstep.Our leverage cutting-edge technology oversee and optimize the entire supply chain, from source to delivery. Our state-of-the-art platform ensures real-time tracking, precise quality control, and efficient distribution.</p>
						</div>
					<!--
					...
					<div class="service_inner">
						<ul>
							<li class="wow fadeInLeft" data-wow-duration="1.5s">
								<div class="inner">
									<img class="svg" src="img/svg/track.svg" alt="" />
									<h3>Real-Time Tracking</h3>
									<p>Monitor the journey of your Mineral Water in real-time, ensuring timely and accurate deliveries from source to destination in 5 Steps...</p>
								</div>
							</li>
							<li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.2s">
								<div class="inner">
									<img class="svg" src="img/svg/inventory.svg" alt="" />
									<h3>Inventory Management</h3>
									<p>Manage stock levels effortlessly with our smart inventory system, preventing shortages and ensuring a constant supply of material....</p>
								</div>
							</li>
							<li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.4s">
								<div class="inner">
									<img class="svg" src="img/svg/customization.svg" alt="" />
									<h3>Company customization</h3>
									<p>Every Company Admin can manage there Sales, Expenses, Clients, Staff, Items and even the Promotional Banners for customers...</p>
								</div>
							</li>
							<li class="wow fadeInLeft" data-wow-duration="1.5s">
								<div class="inner">
									<img class="svg" src="img/svg/reports.svg" alt="" />
									<h3>Business Reports</h3>
									<p>Order Timeline Report, Due Payment Report and Water Bottles Inventory Report are available for company admin to Analyse Busniess Operations...</p>
								</div>
							</li>
							<li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.2s">
								<div class="inner">
									<img class="svg" src="img/svg/customer.svg" alt="" />
									<h3>Customer Insights</h3>
									<p>Gain valuable insights into customer preferences and consumption patterns, enabling personalized service and improved customer satisfaction...</p>
								</div>
							</li>
							<li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.4s">
								<div class="inner">
									<img class="svg" src="img/svg/profits.svg" alt="" />
									<h3>Profit Analysis</h3>
									<p>With Jal Management System, Company can manage the comparison between Sales and Expenditures to know about Real Time Profit of Business...</p>
								</div>
							</li>
						</ul>
		...
		<div class="arlo_tm_section" id="portfolio">
			<div class="arlo_tm_portfolio">
				<div class="container">
					<div class="arlo_tm_main_title">
						<span>Our Subscription Packages</span>
						<h3>Subscription Packages</h3>
					</div>
					<div class="arlo_tm_portfolio">
                       
                            <div class="pricing-container shadow d-flex justify-content-between flex-wrap">
                                @foreach($package as $pack)
                                    <div class="pricing-table shadow flex-grow-1 m-2" style="flex-basis: calc(33.333% - 20px);">
                                        <h3 class="pricing-title">{{ $pack->name }}</h3>
                                        <div class="price">${{ $pack->price }}<sup>/ month</sup></div>
                                        <ul class="table-list">
                                            <li>{{ $pack->no_of_admins }} Company Admin<span> </span></li>
                                            <li>{{ $pack->no_of_setup }} Company Setup<span>&nbsp;</span></li>
                                            <li>{{ $pack->no_of_staff }}<span> Staff </span></li>
                                            <li>{{ $pack->no_of_customers }}<span> Customers </span></li>
                                            <li style="text-transform:Capitalize;">{{ $pack->duration }} Months <span>subscription</span></li>
                                        </ul>
                                        <div class="table-buy">
                                            <center>
                                                <a href="" class="btn btn-primary" data-toggle="modal" data-target="#buyNowModal" data-subscription-id="{{ $pack->id }}" data-subscription-name="{{ $pack->name }}">
                                                    Subscribe Now
                                                </a>
                                            </center>
                                        </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="buyNowModalLabel">Purchase Subscription <span id="modal-subscription-name"></span></h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form name="formCreate" id="formCreate" action="{{ route('front-package.store') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <input type="hidden" name="subscription_id" id="modal-subscription-id" value="">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="name">Name</label>
                                                            <input type="text" class="text-dark form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}">
                                                            @error('name')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="text-dark form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}">
                                                            @error('email')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" class="text-dark form-control @error('password') is-invalid @enderror" id="password" name="password">
                                                            @error('password')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" class="text-dark form-control @error('confirm_password') is-invalid @enderror" id="confirm_password" name="confirm_password">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="text-dark form-control @error('contact') is-invalid @enderror" id="contact_phone" name="contact" value="{{ old('contact') }}">
                                                            @error('contact')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="text-dark form-control @error('logo_img') is-invalid @enderror" id="logo_img" name="logo_img">
                                                            @error('logo_img')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="text-dark form-control @error('address') is-invalid @enderror" id="address" name="address" placeholder="Enter your address">{{ old('address') }}</textarea>
                                                            @error('address')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                            ...
                            <script>
                                $('#buyNowModal').on('show.bs.modal', function (event) {
                                    ...
                                    var subscriptionName = button.data('subscription-name');
                
                                    var modal = $(this);
                                    modal.find('#modal-subscription-id').val(subscriptionId);
                                    modal.find('#modal-subscription-name').text(subscriptionName);
                                });
                            </script>
                        </div>
                    </div>
						...
						<ul class="wow fadeInLeft" data-wow-duration="1.5s">
							<li>
								<div class="list_inner">
									<h3 class="arlo_tm_counter" data-from="0" data-to="70" data-speed="2000">0</h3>
									<span>WATER COMPANIES SUBSCRIBED</span>
								</div>
							</li>
							<li>
								<div class="list_inner">
									<h3 class="arlo_tm_counter" data-from="0" data-to="235" data-speed="2000">0</h3>
									<span>STAFF MEMBERS USING JAL APPLICATION</span>
								</div>
							</li>
							<li>
								<div class="list_inner">
									<h3 class="arlo_tm_counter" data-from="0" data-to="1000" data-speed="2000">0</h3>
									<span>STAFF MEMBERS USING JAL APPLICATION</span>
								</div>
							</li>
							<li>
								<div class="list_inner">
									<h3 class="arlo_tm_counter" data-from="0" data-to="560"SS data-speed="2000">0</h3>
									<span>THOUSANDS LITERS OF WATER DELIVERED</span>
								</div>
							</li>
						</ul>
					</div>
		...
		<style>
            .column_trailer_box:hover .desc {
                background-color: #054072;
            }
    
            .column_trailer_box:hover .subtitle,
            .column_trailer_box:hover h2 {
                color: #fff;
            }
            ...
            textarea {
                ...
                width: 100%;
                /* Reset styles for placeholder and focus */
            ...
            /* Additional focus style for better accessibility */
            input[type="text"]:focus,
            input[type="email"]:focus,
            input[type="password"]:focus,
            textarea:focus {
                outline: none; /* Remove the default outline */
                border-color: #e65f78; /* Set border color on focus */
                box-shadow: 0 0 5px rgba(230, 95, 120, 0.25); /* Add shadow on focus */
            }
            ...
            .anchor_nav li.current a {
                color: #50A2DA; /* Example color for active menu item */
            }
            ...
            * {
            ...
            /* Remove margin from last div if any */
            div:last-child {
                margin-bottom: 0;
                border-bottom: none; /* Optional: remove border from last section */
            }
        ...
        @media (max-width: 768px) {
            ...
            /* About section ki image hide */
            .arlo_tm_about .about_image_wrap {
                display: none;
            }
        ...
        <!--    <div class="container">-->
        <!--        <div class="pricing-container shadow">-->
        <!--            @foreach($package as $pack)-->
        ...
        <!--                        <li>{{ $pack->no_of_admins }} Company Admin<span> </span></li>-->
        <!--                        <li>{{ $pack->no_of_setup }} Company Setup<span>&nbsp;</span></li>-->
        <!--                        <li>{{ $pack->no_of_customers }}<span> Staff </span></li>-->
        <!--                        <li>{{ $pack->no_of_customers }}<span> Customers </span></li>-->
        <!--                        <li style="text-transform:Capitalize;">{{ $pack->duration }} Months <span>subscription</span></li>-->
        <!--                    </ul>-->
        <!--                    <div class="table-buy">-->
        ...
        <!--                    </div>-->
        <!--                    <div class="modal-body">-->
        <!--                        <form name="formCreate" id="formCreate" action="#" method="">-->
        <!--                            @csrf-->
        <!--                            <input type="hidden" name="subscription_id" id="modal-subscription-id" value="">-->
        <!--                            <div class="row">-->
        <!--                                <div class="col-md-6">-->
        ...
        <!--                                    <div class="form-group">-->
        <!--                                        <label for="contact">Contact Number</label>-->
        <!--                                        <input type="text" class="text-dark form-control @error('contact') is-invalid @enderror" id="contact" name="contact" value="{{ old('contact') }}">-->
        <!--                                        @error('contact')-->
        <!--                                        <span class="invalid-feedback" role="alert">-->
        <!--                                            <strong>{{ $message }}</strong>-->
        <!--                                        </span>-->
		...
		<!-- CONTACT -->
		<div class="arlo_tm_section">
			<div class="arlo_tm_contact" id="contact">
				<div class="container">
		...
		<!-- COPYRIGHT -->
		<div class="arlo_tm_section mt-5">
			<div class="arlo_tm_copyright mt-5">
				<div class="container">
					<div class="inner">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const menuItems = document.querySelectorAll('.anchor_nav li a');

    menuItems.forEach(item => {
        item.addEventListener('click', function (event) {
            event.preventDefault();

            // SAFE remove (agar current exist karti ho)
            const currentItem = document.querySelector('.anchor_nav .current');
            if (currentItem) {
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAv_T1QVPmZ0aOuW3dZhlDOBmsAujN_4J4&callback=initMap"></script>
