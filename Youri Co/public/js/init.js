...
function arlo_tm_modalbox_news(){
	...
	list.each(function(){
		...
		buttons.on('click',function(){
			...
			mainImage.css({backgroundImage: 'url('+igData+')'});
...
function arlo_tm_animate_text(){
	...
	animateSpan.typed({
		strings: ["Company Admin Panel", "Customer Mobile App", "Staff/Rider Mobile App"],
		loop: true,
		startDelay: 1e3,
		backDelay: 2e3
	});
...
function arlo_tm_ripple(){
    ...
    try {
        ...
        console.error("Ripple effect initialization failed: ", e.message);
    }
}
