...
class BannersController extends Controller
{
  public function index()
    {
         $userId = Auth::id();
        $banners = Banners::where('created_by', $userId)->get();
        return view('companyAdmin.Banners.index',compact('banners'));
  ...
  public function create()
 {
    ...
    public function store(Request $request)
    {
        ...
        'banner_img' => ['required','image','max:2048','dimensions:width=360,height=460'],
   ...
   public function edit($id)
    ...
    public function statusUpdate(Request $request, $id)
    {
        ...
        $statusMessage = $banner->status ? 'Activated' : 'Deactivated';
        return redirect()->back()->with('success', "Banner $statusMessage successfully!");
    }
